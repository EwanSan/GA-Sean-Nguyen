...
def ga():
    ...
    while gen<100:
        ...
        population1.ListOfIndividuals= crossover_individuals(population1.ListOfIndividuals)
        population1.ListOfIndividuals = mutate(population1.ListOfIndividuals)
        population1.ListOfIndividuals = fitness(population1.ListOfIndividuals)
        population1.ListOfIndividuals = select_individuals(population1.ListOfIndividuals)
        
        population2.ListOfIndividuals= crossover_individuals(population2.ListOfIndividuals)
        ...
        #population1.ListOfIndividuals[-1]=population2.ListOfIndividuals[0]
        ...
        if abs(sum(np.array(population1.ListOfIndividuals[0].gen_code)*np.array(tabdata)))==0 and population1.ListOfIndividuals[0].fitness>population2.ListOfIndividuals[0].fitness:
