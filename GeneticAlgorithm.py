...
def fitness(List): #écart à 0
    for individual in   List:
        ...
        individual.fitness= 1/(1+sum_nb)*sum(individual.gen_code) #la fitness d'une liste qui fait pas 0 n'atteindra jamais plus de nb_of_int
    return List
...
def ga():
    ...
    strat = int(input('1 : 1 population, 200 generations (default strategy if unexpected input)\n2 : 2 populations, warring state\n3 : 2 populations, migration\n'))
    gen=0
    nb_of_gen=200
